...
--näitab tabelisisu, kui kasutaja sisetab gender(sugu) ja departmenID
...
-- sp tegemine
--loeb inimeste arv vastavalt sisestatud genderile
...
--käivitame spGetEmployeeCountByGender
...
--procedure mis ei töötab koretselt, tulemuses annab üks ja sama nimi
--peame lisama where
